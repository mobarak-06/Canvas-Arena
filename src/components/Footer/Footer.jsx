  ...
  return (
    <div>
      <footer className="bg-black mt-9">
        <div className="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-10 lg:px-8">
            ...
            <ul className="mt-8 flex justify-start gap-6 sm:mt-0 sm:justify-end">
              ...
              <li>
                <a
                  ...
                  rel="noreferrer"
                  target="_blank"
                  className="text-gray-100 transition hover:opacity-7"
                >
          ...
          <p className="text-xs text-gray-500 text-center">
            &copy; 2022. Canvas Arena. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
